                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                ?>
                                <form role="form" action="add-receiver-email.php" method="post" enctype="multipart/form-data">
...
<?php 
    if(isset($_POST['submit'])){
        $email = $_POST['email'];
        $q1 = "insert into emails (email, type) values ('".$email."', 'receiver')";
        ...
        if($rez1){
            ...
            echo "<script>
            document.getElementById('email_message').innerHTML = 'Email not added something went wrong!';
            </script>";
        }
    }
